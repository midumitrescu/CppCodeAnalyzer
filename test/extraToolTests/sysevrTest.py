from extraTools.vuldetect.sysevr import *
...
def test():
    ...
    cpgs: List[CPG] = fileParse(file1, calleeInfos, converter, defUseConverter, ddgCreator)
...
def testGenerateSlices():
    ...
    sliceTool: SySeSliceTool = SySeSliceTool(cpgs, sensitive_apis, symbolizingTool)
